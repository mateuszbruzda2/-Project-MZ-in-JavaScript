...
function sprawdz(nr){
    // alert(nr); //sprawdzenie czy generuje się numer przypisany do klikniętej litery
    ...
    for (i=0; i<dlugosc; i++){
        if(haslo.charAt(i) == litery[nr]){
            // alert(i); //sprawdzenie czy dobrze działa sprawdzanie liter w haśle do odgadnięcia 
